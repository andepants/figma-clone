 ...
 * @property {boolean} isInputVisible - Whether AI input panel is visible
 */
interface AIState {
...
interface AIActions {
  ...
  /**
   * Toggle AI input panel visibility
   */
  toggleInputVisibility: () => void;

  /**
   * Set AI input panel visibility
...
export const useAIStore = create<AIStore>((set) => ({
  ...
  toggleInputVisibility: () =>
    set((state) => ({ isInputVisible: !state.isInputVisible })),

  setInputVisibility: (visible) =>
    set({ isInputVisible: visible }),
}));
